...
module.exports = {
    ...
    AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "*SUBZERO VIEWED YOUR STATUS*",  // Status reply message
    ...
    BOT_IMAGE: process.env.BOT_IMAGE || "https://files.catbox.moe/qvqqtp.jpg",  // Bot's "alive" image
