...
module.exports = {
    ...
    PREFIX: configData.PREFIX || ".",  // Command prefix (e.g., "., / ! * - +")
    BOT_NAME: process.env.BOT_NAME || configData.BOT_NAME || "SUBZERO-MD",  // Bot's display name
    ...
    OWNER_NAME: process.env.OWNER_NAME || configData.OWNER_NAME || "Mr Frank",           // Owner's name
